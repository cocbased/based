...
git clean -fd -e 'data/*.json' -e 'data/cwl_history/*.json' -e 'data/cwl_rollups/*.json'

log "Staging JSON payloads."
git add -A -- data/war.json data/war_detail.json data/members.json data/clan_stats.json data/cwl_current.json data/cwl_index.json

git add -A -- data/cwl_history/*.json data/cwl_rollups/*.json 2>/dev/null || true
